...
def insert_audio_clip(background, audio_clip, previous_segments):
    ...
    #previous_segments.add(segment_time)
    #np.concatenate(previous_segments,segment_time)
    #np.append(previous_segments,segment_time)
    #previous_segments = (previous_segments,segment_time)
    ### END CODE HERE ###
